...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('modxpush_core_path', null,
                    $modx->getOption('core_path') . 'components/modxpush/') . 'model/';
            $modx->addPackage('modxpush', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/modxpush/model/schema/modxpush.mysql.schema.xml';
